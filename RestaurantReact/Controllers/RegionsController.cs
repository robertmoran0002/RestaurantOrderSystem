...
namespace RestaurantReact.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public RegionsController(RestaurantDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Regions != null ?
                        ...
                        Problem("Entity set 'RestaurantDBContext.Regions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantDBContext.Regions'  is null.");
            }
            var region = await _context.Regions.FindAsync(id);
            if (region != null)
            {
