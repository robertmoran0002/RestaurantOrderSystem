...
namespace RestaurantOrderSystemMVC.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,OrderId,LocationId,Method,Amount,PaymentTimeStamp,OrderNumber")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,OrderId,LocationId,Method,Amount,PaymentTimeStamp,OrderNumber")] Payment payment)
        {
