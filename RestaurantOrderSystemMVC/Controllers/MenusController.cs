...
namespace RestaurantOrderSystemMVC.Controllers
{
    public class MenusController : Controller
    {
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.MenuCategories, "CategoryId", "CategoryName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Name,Descrption,Notes,CategoryId,Price")] Menu menu)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.MenuCategories, "CategoryId", "CategoryDescription", menu.CategoryId);
            return View(menu);
        }
