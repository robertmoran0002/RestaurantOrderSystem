...
namespace RestaurantOderSystemWeb.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(RestaurantDBContext context)
        {
            _context = context;
        }
        ...
        {
            var restaurantDBContext = _context.Countries.Include(c => c.Region);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantDBContext.Countries'  is null.");
            }
            var country = await _context.Countries.FindAsync(id);
            if (country != null)
            {
