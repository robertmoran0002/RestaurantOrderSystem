    ...
    public class MenuCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.MenuCategories != null ? 
                          ...
                          Problem("Entity set 'RestaurantDBContext.MenuCategories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,CategoryDescription")] MenuCategory menuCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,CategoryDescription")] MenuCategory menuCategory)
        {
